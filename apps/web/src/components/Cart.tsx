            ...
            {cart.map((item, index) => (
              ...
              >
                ...
                <div className="flex gap-4 items-center">
                  <div className="w-20 h-20 bg-emerald-50/50 rounded-xl p-1.5 flex items-center justify-center border border-emerald-100 relative flex-shrink-0 overflow-hidden">
                    <JerseyRenderer
                    ...
                    <div className="flex flex-wrap gap-2 pt-1">
                      ...
                      {getSelectedBadgeLabels(item.product, item.selectedBadges || []).map((label) => {
                        ...
                        return (
                          <span
                            key={label}
                            className="bg-emerald-50 text-emerald-700 text-[10px] font-mono px-2 py-0.5 rounded border border-emerald-100"
                          >
                            + {label}{custom ? `: ${custom}` : ''}
                          </span>
                        );
